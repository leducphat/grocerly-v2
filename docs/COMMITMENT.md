...
Đã chốt: L-1 (sửa đặc tả), L-6, L-7, L-8 (sửa code, 21/09/2026), L-9 và L-10 (sửa
code, 22/09/2026). Bộ test không còn `xfail` nào. Nếu các chỗ còn lại chốt theo đề
xuất: thêm **2 lần sửa đặc tả** (L-2, L-4 — ghi vào `PLAN.md` §6) và **2 lần sửa
code** (L-3, L-5), mỗi lần có test đi kèm; hai lỗi này chưa có test tái hiện nên
phải viết test trước rồi mới sửa.
