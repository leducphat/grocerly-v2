...
| 12 | 23/09/2026 | SRS §4.4 (FR-A-02), §6.1 | Bỏ bước Admin duyệt sản phẩm: sản phẩm nhân viên tạo hiển thị ngay, Admin vẫn ẩn hoặc gỡ bán được | Chốt L-2 theo hướng sửa đặc tả (D-028). Bước duyệt sinh ra cho mô hình nhiều người bán mà D-015 đã bỏ; nhân viên cửa hàng duyệt hàng của chính mình thì không có nghĩa | `464233c` |
| 13 | 23/09/2026 | SRS §6 (UC-14), §6.1 | Bỏ chữ "(CRUD)" ở UC-14; viết rõ khách chỉ tạo đánh giá, quản trị viên kiểm duyệt | Chốt L-4 theo hướng sửa đặc tả (D-028). Cam kết CRUD đầy đủ cho người viết là tự thêm chức năng vào mẫu số của TC2.2 mà không định làm | `464233c` |
