...
| 11–12/09/2026 | Claude Code (Opus 5) + bộ công cụ ECC | P-07 tách `SRS.md` / `SDD.md`; viết báo cáo Tuần 1 | "làm P-07 trước, làm xong rồi hãy qua ghi báo cáo tuan-01.md"; "commit và push"; "mở PR và merge vào main đi" | Tạo `docs/SDD.md`: chuyển nguyên văn SRS Mục 7–9 (đánh số lại 1–3), thêm phần đầu, ghi chú "nợ thiết kế", mục lịch sử chỉnh sửa. Sửa `SRS.md`: thay ghi chú "sẽ tách", đánh số lại Mục 10–12 → 7–9. Cập nhật link SDD ở `AGENTS.md`/`CLAUDE.md`, `PLAN.md` (P-05, P-06, P-07, §5, §6 dòng 4), `DECISIONS.md`, `weekly_report/README.md`, `_TEMPLATE.md`. Kiểm tra bằng `diff` rằng khối nội dung chuyển sang không đổi chữ nào. Tạo `weekly_report/tuan-01.md` từ `git log`, `gh pr list` và các file `docs/` | SV bỏ ô *Hình thức trao đổi với GVHD* khỏi `tuan-01.md`. AI tự quyết để Kiểm thử và Hạn chế ở lại SRS (D-011 không nói tới hai mục này) | `0af7a42`, `c5ed01c`, `7baa3e8` (PR #4) |
